...
Item {
    ...
    Column {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    TextInput {
                        ...
                        color: Theme.text
                        font.pixelSize: 13
                        text: pageRoot.slowLogLongQueryTime
        ...
        Rectangle {
            ...
            Components.AppScrollEditor {
                ...
                anchors.fill: parent
                anchors.margins: 12
                text: dashboardBridge && dashboardBridge.databaseRuntimeLog.length > 0
                    ? dashboardBridge.databaseRuntimeLog
    ...
    Native.Menu {
        id: databaseSlowLogMenu
        Native.MenuItem {
            text: Strings.t("copy")
            enabled: slowLogText.selectedText.length > 0
            onTriggered: slowLogText.copy()
        }
        Native.MenuSeparator {}
        Native.MenuItem {
            text: Strings.t("select.all")
            enabled: slowLogText.length > 0
