...
Item {
    ...
    Components.SettingsTabFrame {
        ...
        ColumnLayout {
            ...
            Label {
                Layout.fillWidth: true
                text: "Choose which packaged Nginx runtime should be active."
                color: Theme.muted
                font.pixelSize: 13
            ...
            ScrollView {
                ...
                Column {
                    ...
                    Repeater {
                        model: pageRoot.nginxRuntimeModel

                        delegate: Rectangle {
                            required property int index
                            property var runtimeItem: pageRoot.nginxRuntimeModel[index]
                            width: parent.width
                            height: 72
                            radius: Theme.radius
                            color: "transparent"
                            ...
                            RowLayout {
                                ...
                                Components.AppButton {
                                    ...
                                    onClicked: dashboardBridge.saveWebServerRuntimeSettings(
                                        "nginx",
                                        String(dashboardBridge.settingsApacheRuntime || ""),
                                        runtimeItem.id
                                    )
